...
public class WeddingDomain extends BaseWeddingDomain {
    ...
    @OneToMany(mappedBy = "weddingDomain", cascade = CascadeType.REMOVE, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<WeddingCommentEntity> commentEntityList = new ArrayList<>();
